...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Thales', 'Admin']
  ...
  # config.excluded_models = [Answer, Authentication, Ckeditor::Asset, Ckeditor::AttachmentFile, Ckeditor::Picture, Exercise, Introduction, Question, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Answer, Authentication, Ckeditor::Asset, Ckeditor::AttachmentFile, Ckeditor::Picture, Exercise, Introduction, Question, User]
  ...
  #     configure :data_content_type, :text 
  #     configure :data_file_size, :integer 
  #     configure :width, :integer 
  #     configure :height, :integer 
  #     configure :assetable_type, :text         # Hidden 
  #     configure :assetable_id, :bson_object_id         # Hidden   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :data_content_type, :text         # Hidden 
  #     configure :data_file_size, :integer         # Hidden 
  #     configure :width, :integer 
  #     configure :height, :integer 
  #     configure :assetable_type, :text         # Hidden 
  #     configure :assetable_id, :bson_object_id         # Hidden 
  #     configure :data_file_name, :text         # Hidden 
  #     configure :data_updated_at, :datetime         # Hidden 
  #     configure :data, :paperclip   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
